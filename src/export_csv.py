...
def export_mitbih_to_csv(record_id, output_path=None):
    """把MIT-BIH记录导出为带表头CSV：time,voltage"""
    file_path = f"D:/桌面/ECG-Auxiliary-Screening/data/mitbih/mit-bih-arrhythmia-database-1.0.0/{record_id}.dat"
    ...
    if output_path is None:
        output_path = f"uploads/{record_id}_30s.csv"
